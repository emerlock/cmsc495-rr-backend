...
const loginUser = async (req, res) => {
    ...
    const isValid = await comparePassword(password, user.password).catch(err => console.log(err.message))
...
const registerUser = async (req, res) => {
    ...
    const hashedPassword = await hashPassword(password).catch(err => console.log(err.message))
